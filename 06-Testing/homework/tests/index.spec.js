...
describe('Test de APIS', () => {
  ...
  describe('POST /product', () => {
    ...
    it('responds with 400', () => agent.post('/product').send({ a: 2, b: 'kjhlk' }).expect(400));
  ...
  describe('POST /sumArray', () => {
    ...
    it('should response with false if the combination  of two numbers matches num', () =>
      agent.post('/sumArray')
  ...
  describe('POST /numString', () => {
    it('responds with status 200', () => agent.post('/numString').send({ s: "David" }).expect(200));
    it('responds with status 400 if the String is a number', () => agent.post('/numString').send({ s: 4 }).expect(400));
    it('responds with status 400 if the String is empty', () => agent.post('/numString').expect(400));
  ...
  describe('POST /pluck', () => {
    ...
    it('responds with status 404 if Array is not an array', () => 
      agent.post('/pluck').send({ array: "david", prop: "name" }).expect(404));
